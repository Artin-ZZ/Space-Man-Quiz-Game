...
class Ui_quiz(object):
    def setupUi(self, quiz):
        ...
        self.ab_dev.setGeometry(QtCore.QRect(10, 0, 231, 40))
        font = QtGui.QFont()
        ...
        self.mng_qu_nat = QtWidgets.QPushButton(self.start)
        self.mng_qu_nat.setGeometry(QtCore.QRect(10, 60, 311, 40))
        font = QtGui.QFont()
        font.setFamily("Word Black")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(50)
        self.mng_qu_nat.setFont(font)
        self.mng_qu_nat.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.mng_qu_nat.setStyleSheet("QPushButton {\n""color: rgb(255, 255, 255);\n""}\n""QPushButton:hover {\n""\n""color: rgb(55, 26, 70);\n""}")
        self.mng_qu_nat.setObjectName("Manage Nature")
        self.pubkn_mng = QtWidgets.QPushButton(self.start)
        self.pubkn_mng.setGeometry(QtCore.QRect(10, 100, 430, 40))
        font = QtGui.QFont()
        font.setFamily("Word Black")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(50)
        self.pubkn_mng.setFont(font)
        self.pubkn_mng.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pubkn_mng.setStyleSheet("QPushButton {\n""color: rgb(255, 255, 255);\n""}\n""QPushButton:hover {\n""\n""color: rgb(55, 26, 70);\n""}")
        self.pubkn_mng.setObjectName("Manage Info")
        self.sport_mg = QtWidgets.QPushButton(self.start)
        self.sport_mg.setGeometry(QtCore.QRect(10, 150, 290, 40))
        font = QtGui.QFont()
        font.setFamily("Word Black")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(50)
        self.sport_mg.setFont(font)
        self.sport_mg.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.sport_mg.setStyleSheet("QPushButton {\n""color: rgb(255, 255, 255);\n""}\n""QPushButton:hover {\n""\n""color: rgb(55, 26, 70);\n""}")
        self.sport_mg.setObjectName("Manage Sports")
        self.math_int = QtWidgets.QPushButton(self.start)
        self.math_int.setGeometry(QtCore.QRect(10, 200, 280, 40))
        font = QtGui.QFont()
        font.setFamily("Word Black")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(50)
        self.math_int.setFont(font)
        self.math_int.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.math_int.setStyleSheet("QPushButton {\n""color: rgb(255, 255, 255);\n""}\n""QPushButton:hover {\n""\n""color: rgb(55, 26, 70);\n""}")
        self.math_int.setObjectName("Manage Math")
        self.tech_mng = QtWidgets.QPushButton(self.start)
        self.tech_mng.setGeometry(QtCore.QRect(320, 0, 250, 70))
        font = QtGui.QFont()
        font.setFamily("Word Black")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(50)
        self.tech_mng.setFont(font)
        self.tech_mng.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.tech_mng.setStyleSheet("QPushButton {\n""color: rgb(255, 255, 255);\n""}\n""QPushButton:hover {\n""\n""color: rgb(55, 26, 70);\n""}")
        self.tech_mng.setObjectName("Manage Tech")
        self.cma_mng = QtWidgets.QPushButton(self.start)
        self.cma_mng.setGeometry(QtCore.QRect(650, 0, 300, 40))
        font = QtGui.QFont()
        font.setFamily("Word Black")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(50)
        self.cma_mng.setFont(font)
        self.cma_mng.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.cma_mng.setStyleSheet("QPushButton {\n""color: rgb(255, 255, 255);\n""}\n""QPushButton:hover {\n""\n""color: rgb(55, 26, 70);\n""}")
        self.cma_mng.setObjectName("Manage Cinema")
        ...
        self.back_question.setPixmap(QtGui.QPixmap("Pics/question.jpg"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Pics/time-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Pics/delete-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.back_win.setPixmap(QtGui.QPixmap("Pics/win.jpg"))
        ...
        self.back_lost.setPixmap(QtGui.QPixmap("Pics/lost.jpg"))
    ...
    def retranslateUi(self, quiz):
        ...
        self.gametolearn.setText(_translate("quiz", "Play And Learn!"))
        self.letsgo.setText(_translate("quiz", "Let's Go"))
        self.ab_dev.setText(_translate("quiz", "About Developer"))
        self.mng_qu_nat.setText(_translate("quiz", "Manage Nature Category"))
        self.pubkn_mng.setText(_translate("quiz", "Manage Public Knwoledge Category"))
        self.tech_mng.setText(_translate("quiz", "Manage Technology\nCategory"))
        self.sport_mg.setText(_translate("quiz", "Manage Sport Category"))
        self.cma_mng.setText(_translate("quiz","Manage Cinema Category"))
        self.math_int.setText(_translate("quiz", "Manage Math Category"))
        self.title_select.setText(_translate("quiz", "Choose Quiz Question Pack:"))
        self.tech.setText(_translate("quiz", "Technology"))
        self.sport.setText(_translate("quiz", "Sports"))
        self.info.setText(_translate("quiz", "Public knowledge"))
        self.cinema.setText(_translate("quiz", "Cinema"))
        self.math.setText(_translate("quiz", "Math & intelligence"))
        self.nature.setText(_translate("quiz", "Nature"))
        self.level.setText(_translate("quiz", "22"))
        self.username.setText(_translate("quiz", "username"))
        ...
        self.buy_time.setText(_translate("quiz", "خریدن وقت اضافه"))
        self.buy_option.setText(_translate("quiz", "حذف گزینه اشتباه"))
        self.label_coin.setText(_translate("quiz", "سکه ها:"))
        self.level2.setText(_translate("quiz", "22"))
        self.label_user.setText(_translate("quiz", "اسم شما:"))
        self.username2.setText(_translate("quiz", "art_rtx"))
        self.title_win.setText(_translate("quiz", "Nice Keep It Up :)"))
        self.next.setText(_translate("quiz", "Next Question"))
        self.end.setText(_translate("quiz", "End Game"))
        self.title_lost.setText(_translate("quiz", "Oh No! You Lost :("))
        self.next2.setText(_translate("quiz", "Next Question"))
        self.end2.setText(_translate("quiz", "End Game"))